from MetricsForID3 import necessary_elements_for_train, get_learning_curve_points, plot_learning_curve, classifier
from ID3 import ID3
...
def run_ID3():
    ...
    while True:
        ...
        if choice == "1":
            ...
            necessary_elements_for_train(available_words, train_positive_reviews, train_negative_reviews, train_reviews)
